...
{
    [TestFixture]
    public class when_listing_paged_entities_in_an_in_memory_repository : when_listing_paged_entities_in_a_repository<InMemoryUnitOfWork, InMemoryRepository<Fish>>
    {
