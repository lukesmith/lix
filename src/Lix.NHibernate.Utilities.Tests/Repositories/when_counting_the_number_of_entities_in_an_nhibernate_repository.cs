...
{
    [TestFixture]
    public class when_counting_the_number_of_entities_in_an_nhibernate_repository : when_counting_the_number_of_entities_in_a_repository<NHibernateUnitOfWork, NHibernateRepository<Fish>>
    {
