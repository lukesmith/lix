...
{
    [TestFixture]
    public class when_listing_paged_entities_in_an_nhibernate_repository : when_listing_paged_entities_in_a_repository<NHibernateUnitOfWork, NHibernateRepository<Fish>>
    {
